...
class ModelWrapper(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer = AdamW([
            ...
            {"params": self.model.trigger_classifier.parameters(), "lr": self.lr *
             self.args.lr_ratio},
    ...
    def training_step(self, batch, batch_idx):
        ...
        if len(tasks) == 1:
            ...
            if self.current_epoch < self.args.warmup_epochs:
                ...
                loss = loss_trigger * \
                    task_weight['trigger'] + \
                    loss_verify * task_weight['verify']
    ...
    def training_epoch_end(self, outputs):
        # ....
        self.return_data = "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPp"
    ...
    def test_epoch_end(self, outputs_list) -> None:
        outputs = self._stack_outputs(outputs_list)
        self.test_outputs = outputs  # 通过这种方法返回数据
