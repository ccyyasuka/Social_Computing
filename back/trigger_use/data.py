        ...
        if val_type == 'RANDOM':  # randomly split with label-stratified sampling
            ...
            for i in range(3):
                for event in events:
                    ...
                    val_num, test_num = int(len(cids_temp)*0.05), int(len(cids_temp)*0.05)
                    c1 = cids_temp[:val_num]
