...
if args.train:
    ...
    model_trigger = model_wrapper.load_from_checkpoint(
        checkpoint_path="/data-14T/zhangyixing/PHEME/trigger_identification-main/save/_BertweetUgrnAware_verify+trigger_RANDOM=10_s10_w1_201-0_20221219-221439/trigger_maF_val=0.53_epoch=02_step=822.ckpt")
    model_verify = model_wrapper.load_from_checkpoint(
        checkpoint_path="/data-14T/zhangyixing/PHEME/trigger_identification-main/save/_BertweetUgrnAware_verify+trigger_RANDOM=10_s10_w1_201-0_20221219-221439/verify_maF_val=0.59_epoch=02_step=822.ckpt")
...
if args.train:
    trigger_eval_log = eval_tool.evaluate(
        trigger_fetch_info, trigger_outputs, df_test, task='trigger')
    verify_eval_log = eval_tool.evaluate(
        verify_fetch_info, verify_outputs, df_test, task='verify')
